...
* Attendees should be able to identify many of the items listed in the "Sample Issues.docx" document located in the coach's resources tab. You can leverage the document as a reference.
